...
#emailField.send_keys("asdfjkl@kent.edu")
...
usernameError = driver.find_element_by_name("usernameError")
string1 = usernameError.get_attribute('innerHTML')
print(string1)

if(string1.find("This field is required.")) == -1:
    print("test failed.")
else:
    print("TEST PASSED!")
sleep(5)
